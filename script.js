document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            // Intenta reproducir el audio. Debe estar silenciado por defecto (muted) en el HTML.
            if (music) {
    ...
    // --- 3. Control de Música de Fondo (Manejo de Silencio/Sonido) ---

    // El ícono inicial es 'fa-volume-xmark' (silencio)
    musicToggle.addEventListener('click', () => {
        if (music.muted) {
            music.muted = false;
            musicIcon.classList.remove('fa-volume-xmark');
            musicIcon.classList.add('fa-volume-high'); // Sonido activo
            ...
            musicIcon.classList.add('fa-play'); // Pausa (mostrar play)
            music.muted = false; // Mantenerlo listo para reproducir con volumen si se presiona play
        }
    });
    ...
    const generateTicketHtml = (name) => {
        ...
        // **Clase 'new-ticket' añadida para animación de entrada**
        return `
            <div class="magic-ticket new-ticket"> 
    ...
    rsvpForm.addEventListener('submit', (e) => {
        ...
        // **Scroll suave y enfocado**
        setTimeout(() => {
            ticketDisplay.scrollIntoView({ behavior: 'smooth', block: 'start' });
        }, 100); 
        
        // Desactivar el formulario después de generar
